    ...
    return (
        <View style={styles.card}>
            ...
            <View style={styles.body}>
                <Text style={[styles.name, rtlAwareTextStyle(place.name)]} numberOfLines={2}>{place.name}</Text>
                {!!place.description && (
                    <Text style={[styles.description, rtlAwareTextStyle(place.description)]} numberOfLines={3}>
                        {place.description}
                    </Text>
                )}
                {!!saveError && (
                    <Text style={[styles.errorText, rtlAwareTextStyle(saveError)]}>{saveError}</Text>
                )}
            </View>
            <TouchableOpacity
                onPress={onAdd}
